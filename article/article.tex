...
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
%which are the joined phenotypes, what's the consequence? e.g. what does it mean that mouse + human share steroid hormone? 
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
~~~~~~~\\
\begin{table}[H]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
%what are the similarites, differences? How does the mouse study involve human phenotypes?
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
