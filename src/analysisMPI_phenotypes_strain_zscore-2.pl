...
sub usage{
    ...
    print "Usage: perl analysisMPI_phenotypes_strain_zscore-2.pl --outputFile <path_to_plot_file> [--d|debug]\n";
    print "       $0 --help \n";
    print "       $0 --man \n";
    exit;
}
...
#extract plot data
my ($phenotypes, $nr, $count) = MODULES::PlotsExtract::get_analysisMPI_phenotypes_strain_zscore2_neg();
...
=head1 NAME
 ...
 analysisMPI_phenotypes_strain_zscore-2.pl - creates MPI-Strain-Phenotypes having zscore > 2 distribution plot, for the phenotypes found in the MPI database.
